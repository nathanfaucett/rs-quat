...
#[inline(always)]
pub fn rotate_y<T: Num>(out: &mut [T; 4], a: [T; 4], angle: T) -> &mut [T; 4] {
    let ax = a[0];
    let ay = a[1];
    let az = a[2];
    let aw = a[3];
...
#[inline(always)]
pub fn rotate_z<T: Num>(out: &mut [T; 4], a: [T; 4], angle: T) -> &mut [T; 4] {
    let ax = a[0];
    let ay = a[1];
    let az = a[2];
    let aw = a[3];
...
#[inline(always)]
pub fn look_rotation<T: Num>(out: &mut [T; 4], forward: [T; 3], up: [T; 3]) -> &mut [T; 4] {
    let fx = forward[0];
    let fy = forward[1];
    let fz = forward[2];
    let ux = up[0];
...
#[inline(always)]
pub fn from_axis_angle<T: Num>(out: &mut [T; 4], axis: [T; 3], angle: T) -> &mut [T; 4] {
    let half_angle = angle / T::from_isize(2isize);
...
#[inline(always)]
pub fn from_mat2<T: Num>(out: &mut [T; 4], m: [T; 4]) -> &mut [T; 4] {
    from_mat(
        out,
        m[0], m[2], T::zero(),
        m[1], m[3], T::zero(),
...
#[inline(always)]
pub fn from_mat32<T: Num>(out: &mut [T; 4], m: [T; 6]) -> &mut [T; 4] {
    from_mat(
        out,
        m[0], m[2], T::zero(),
        m[1], m[3], T::zero(),
...
#[inline(always)]
pub fn from_mat3<T: Num>(out: &mut [T; 4], m: [T; 9]) -> &mut [T; 4] {
    from_mat(
        out,
        m[0], m[3], m[6],
        m[1], m[4], m[7],
...
#[inline(always)]
pub fn from_mat4<T: Num>(out: &mut [T; 4], m: [T; 16]) -> &mut [T; 4] {
    from_mat(
        out,
        m[0], m[4], m[8],
        m[1], m[5], m[9],
